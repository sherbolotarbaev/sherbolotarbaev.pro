...
import text from "@/app/lib/data/experience.json";

import { Prompt } from "next/font/google";
import { LinkSvg, ManchoSvg, WedevxSvg } from "@/app/lib/assets/svg";
import styles from "@/app/components/styles/experience.module.scss";

const Video = dynamic(() => import("@/app/components/ui/video"), {
  ssr: false,
